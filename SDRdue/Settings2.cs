...
namespace SDRdue
{
    public partial class Settings2 : Form
    {
        ...
        public delegate void MyDelegate(int item);
        ...
        public event MyDelegate EventRadio;
        public event MyDelegateSettings EventGain;
        ...
        private void Settings2_FormClosing(object sender, FormClosingEventArgs e)
        {
            e.Cancel = true;
            this.Visible = false;
        }

        public void Settings_Update(ref Find find)
        {
        ...
        void SendSettings()
        {
            ...
            if (EventGain != null)
                EventGain(1, gain_index, rate, AGC, MGC, ShiftOn, shift, sampling, Dithering, StagesFlag, gain_stage);
        }
